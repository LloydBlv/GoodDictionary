...
import com.example.worddetails.WordDetailScreen
import com.example.wordslist.WordsListScreen

@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@Composable
internal fun MainContentView(modifier: Modifier = Modifier) {
